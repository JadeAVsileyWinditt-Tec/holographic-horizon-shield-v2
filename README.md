...
| Event-horizon threshold | 9.62 M☉                                 | Mass limit that triggers containment |
| Distance constraint     | 1,560.4 ly                              | Token chaotic-drift monitor          |

When calculated mass M exceeds 9.62 M☉, the request is treated as a Horizon Breach and diverted into the tarpit.
